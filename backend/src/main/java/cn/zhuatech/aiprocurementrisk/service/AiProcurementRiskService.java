...
import cn.zhuatech.aiprocurementrisk.domain.DomainCatalog;
import cn.zhuatech.aiprocurementrisk.model.*;
import cn.zhuatech.aiprocurementrisk.repository.*;
 ...
 */
@Service
public class AiProcurementRiskService {
     ...
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    public AiProcurementRiskService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
